...
vector <double> perform_one_PAD_iteration_with_attribution_distance_cutoff(const vector <vector <double>> &points1, const  vector <vector <double>> &points2,  vector <double> &values1, vector <double> &values2,  vector <size_t> &index_list1, vector <size_t> &index_list2, kdtree::KdTree &kdtree1, kdtree::KdTree &kdtree2, long &idum, const bool f1_is_fa, const double squared_attribution_distance_cutoff)
	{
...
vector <vector <double>> calculate_PAD_results_assume_same_grid_and_remove_overlap(const vector <vector <double> > &points1, const vector <vector <double> > &points2, const double attribution_distance_cutoff, vector <double> &values1, vector <double> &values2)
	{

	const double	squared_attribution_distance_cutoff = attribution_distance_cutoff * attribution_distance_cutoff;
...
vector <vector <double>> calculate_PAD_results_assume_different_grid(const vector <vector <double> > &points1, const vector <vector <double> > &points2, const double attribution_distance_cutoff, vector <double> &values1, vector <double> &values2)
	{
	const double	squared_attribution_distance_cutoff = attribution_distance_cutoff * attribution_distance_cutoff;
